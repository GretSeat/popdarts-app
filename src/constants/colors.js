...
export const POPDARTS_COLORS = [
  ...
  // Party Set
  {
    ...
    colors: ["#52260F", "#944923", "#89441D"],
    isGradient: true,
    sprinkles: [
      { top: "20%", left: "5%", color: "#180200", rotate: "20deg" },
      { top: "60%", left: "10%", color: "#180200", rotate: "75deg" },
      { top: "40%", left: "15%", color: "#180200", rotate: "140deg" },
      { top: "80%", left: "20%", color: "#180200", rotate: "300deg" },
      { top: "30%", left: "25%", color: "#180200", rotate: "45deg" },
      { top: "70%", left: "30%", color: "#180200", rotate: "200deg" },
      { top: "50%", left: "35%", color: "#180200", rotate: "15deg" },
      { top: "25%", left: "40%", color: "#180200", rotate: "85deg" },
      { top: "75%", left: "45%", color: "#180200", rotate: "260deg" },
      { top: "35%", left: "50%", color: "#180200", rotate: "120deg" },
      { top: "65%", left: "55%", color: "#180200", rotate: "50deg" },
      { top: "45%", left: "60%", color: "#180200", rotate: "100deg" },
      { top: "55%", left: "65%", color: "#180200", rotate: "30deg" },
      { top: "15%", left: "70%", color: "#180200", rotate: "175deg" },
      { top: "70%", left: "75%", color: "#180200", rotate: "90deg" },
      { top: "40%", left: "80%", color: "#180200", rotate: "45deg" },
      { top: "60%", left: "85%", color: "#180200", rotate: "200deg" },
      { top: "35%", left: "90%", color: "#180200", rotate: "60deg" },
      { top: "75%", left: "95%", color: "#180200", rotate: "120deg" },
    ],
  },
  {
    name: "Party Vanilla",
